...
export function TitleAbout() {
  return (
    <Container>
      <h1 className={style.mainText}>About me</h1>
      <div className='content'>
        <div className='text'>
          <h2>Un placer conocerte, soy Yhonder</h2>
          <p>Me especializa tanto en frontend como en backend, lo que me permite tener una visión integral del desarrollo de aplicaciones. Mi curiosidad insaciable es lo que me lleva a aprender constantemente nuevas tecnologías y herramientas que mejoran mi capacidad de creación y optimización.</p>
